...
const journeys = [
  ...
  { label: "Горы", title: "Архыз\nкруглый год", text: "Зимой - катание, летом - маршруты, воздух и тишина. Для семейных поездок, активного отдыха и путешествий вдвоем.", facts: ["Горнолыжный сезон", "SPA и бассейны"], image: "/alean-04.jpg", link: "Открыть Архыз" },
  { label: "Отели", title: "Выбрать\nпо настроению", text: "Сравните курорты по бренду, локации, питанию и возможностям для детей. Вся коллекция доступна в одном каталоге.", facts: ["21 отель", "8 городов"], image: "/alean-05.webp", link: "Подобрать отель" },
];
  ...
  return <div className="journey-carousel shell">
    <article className="journey-slide" style={{ backgroundImage: `url('${current.image}')` }}>
      <div className="journey-content">
        ...
        <a href="#hotels">{current.link} <i>↗</i></a>
      </div>
