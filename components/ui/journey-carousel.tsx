...
const journeys = [
  { label: "Море", title: "Отдых у моря\nдля всей семьи", text: "Анапа, Геленджик и Сочи. Первая береговая линия, детские клубы, SPA и формат «Ультра все включено».", facts: ["7 семейных курортов", "Отели 4* и 5*"], image: "/alean-01.webp", link: "Смотреть отели" },
  { label: "Горы", title: "Архыз\nкруглый год", text: "Зимой - катание, летом - маршруты, воздух и тишина. Для семейных поездок, активного отдыха и путешествий вдвоем.", facts: ["Горнолыжный сезон", "SPA и бассейны"], image: "/alean-04.jpg", link: "Смотреть отели в горах" },
  { label: "Отели", title: "Выбрать\nпо настроению", text: "Сравните курорты по бренду, локации, питанию и возможностям для детей. Вся коллекция доступна в одном каталоге.", facts: ["21 отель", "8 городов"], image: "/alean-05.webp", link: "Выбрать отель" },
];
  ...
  return <div className="journey-carousel shell">
    <article className="journey-slide" style={{ backgroundImage: `url('${current.image}')` }}>
      <div className="journey-content">
        ...
        <a className="journey-link" href="#hotels">{current.link}</a>
      </div>
