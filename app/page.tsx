  ...
  return <main>
    ...
    <section className="brands" id="brands">
      ...
      <div className="brand-grid shell">
        ...
        <article className="brand-card brand-club"><div className="brand-copy"><span>Горы</span><h3>Архыз<br/>круглый год</h3><p>Зимой - катание, летом - маршруты, воздух и тишина. Для семейных поездок и отдыха вдвоем.</p><ul><li>Горнолыжный сезон</li><li>SPA и бассейны</li></ul></div><a href="#hotels">Открыть Архыз <i>↗</i></a></article>
        <article className="brand-card brand-select"><div className="brand-copy"><span>Отели</span><h3>Выбрать<br/>по настроению</h3><p>Сравните отели по бренду, локации, питанию и возможностям для детей.</p><ul><li>21 отель</li><li>8 городов</li></ul></div><a href="#hotels">Подобрать отель <i>↗</i></a></article>
      </div>
    </section>

    <section className="catalog shell" id="hotels">
      <div className="section-head"><div><p className="micro">Отели коллекции</p><h2>Место для<br/>вашей поездки</h2></div><button type="button" className="line-link">Выбрать отель <span aria-hidden="true">↗</span></button></div>
